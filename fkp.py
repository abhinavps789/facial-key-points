...
# Splitting into clean and unclean depending on the availability of data
...
# Performing brightness alteration
...
# Performing horizontal and vertical shifts
...
# Expanding the dataset depending on the user's desires
